...
func TestNewSSHCommander( t *testing.T) {
  ...
  creator.Create("root", "localhost", "22", "")
...
func TestCreateCommandStringSetsPortHostUser( t *testing.T) {
  creator := sshcommandcreator.SSHCommandCreator{}
  creator.Create("myuser", "differenthost", "20010", "")
  actualResult, _ := creator.CreateCommandString("echo hellocommand")
...
func TestCreateCommandStringNestedWorks( t *testing.T) {
  creator1 := sshcommandcreator.SSHCommandCreator{}
  creator1.Create("myuser", "differenthost", "20010", "")
  creator2 := sshcommandcreator.SSHCommandCreator{}
  creator2.Create("myother", "otherhost", "10099", "")
